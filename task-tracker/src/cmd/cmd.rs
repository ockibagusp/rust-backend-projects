...
pub trait CommandTrait {
    ...
    fn task_cli(&mut self, args: &Vec<String>) -> Result<String, Error>;
    fn mark_cli(&mut self, args: &Vec<String>) -> Result<String, Error>;
    fn list_cli(&mut self, args: &Vec<String>) -> Result<String, Error>;
