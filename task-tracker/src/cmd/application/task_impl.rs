use crate::cmd::domain::models::{Task, TaskBuilder, TaskStatus, TaskTrait};
...
const ERR_DESCRIPTION_INVALID: &str =
    "DESCRIPTION is too short(min. 2 chars) or too long(max. 50 chars)";
...
impl TaskTrait for Task {
    ...
    fn is_validation(&self) -> Result<(), &'static str> {
        ...
        {
            return Err(ERR_DESCRIPTION_INVALID);
        }
